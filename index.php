      ...
      <div class="conteudo">
         <nav class="modulos">
            ...
            <div class="modulo roxo">
               ...
               <ul>
               <li><a href="exercicio.php?dir=estruturas&file=if_else">If & Else</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=operadores_relacionais">Op. Relacionais</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=desafio_pi">Desafio PI</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=operadores_logicos">Operadores Lógicos</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=get_post">Get & Post</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=desafio_operadores">Desafio Operadores Lógicos</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=operador_ternario">Operador Ternário</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=operador_switch">Switch</a></li>
               <li><a href="exercicio.php?dir=estruturas&file=desafio_switch">Desafio Switch</a></li>
               </ul>
            </div>
            <div class="modulo azul">
               ...
               <ul>
                  ...
                  <li><a href="exercicio.php?dir=variaveis&file=valores_referencia">Valores por referência</a></li>
